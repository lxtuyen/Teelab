package com.example.Teelab.mapper;

import com.example.Teelab.dto.ProductDto;
import com.example.Teelab.dto.ProductResourceDto;
import com.example.Teelab.dto.ProductVariantDto;
import com.example.Teelab.entities.*;
import com.example.Teelab.services.CategoryService;
    ...
    public Product mapToProductEntity(ProductDto productDto) {
        ...
        if (null != category) {
            ...
            CategoryType categoryType = category.getCategoryTypes()
                    .stream().filter(categoryType1 -> categoryType1.getId()
